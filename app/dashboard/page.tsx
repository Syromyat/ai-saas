        ...
        <div className="mb-12">
          <div className="flex justify-between items-start mb-8">
            <div>
              <h1 className="text-4xl font-bold mb-2">
                Добро пожаловать, <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">{user?.email?.split('@')[0]}</span>
              </h1>
          ...
          {profile?.plan === 'free' && (
            <div className="p-4 rounded-lg bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 flex justify-between items-center">
              ...
              <Link href="/pricing" className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all whitespace-nowrap ml-4">
                Обновить
              </Link>
            </div>
          )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="p-8 rounded-3xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-blue-400/20 backdrop-blur-xl hover:border-blue-400/50 transition-all">
              <h2 className="text-2xl font-bold mb-6">AI Генератор</h2>
              <GeneratorForm />
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-blue-400/20">
              ...
              <div className="space-y-3">
                <Link href="/history" className="block p-3 rounded-lg bg-slate-700/50 hover:bg-blue-500/20 transition-all text-sm">
                  📊 История запросов
                </Link>
                <Link href="/pricing" className="block p-3 rounded-lg bg-slate-700/50 hover:bg-blue-500/20 transition-all text-sm">
                  💳 Тарифы
                </Link>
                <Link href="/referral" className="block p-3 rounded-lg bg-slate-700/50 hover:bg-blue-500/20 transition-all text-sm">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-500/10 to-purple-500/10 border border-blue-400/30">
              <h3 className="font-bold mb-3">💡 Совет</h3>
